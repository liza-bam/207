...
(function () {
  ...
  const PATHS = {
    ...
    gift: ["M5 11h14v9H5z", "M3 8h18v3H3z", "M12 8v12", "M12 8C11 5.5 7 5.5 7 7.5 7 9 10.5 9 12 8", "M12 8C13 5.5 17 5.5 17 7.5 17 9 13.5 9 12 8"],
    alert: ["M10.3 4.4 2.4 18a2 2 0 0 0 1.7 3h15.8a2 2 0 0 0 1.7-3L13.7 4.4a2 2 0 0 0-3.4 0Z", "M12 9.5v4", "M12 17h.01"],
  };
